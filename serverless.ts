...
const serverlessConfiguration: AWS = {
  ...
  provider: {
    ...
    environment: {
      ...
      AUTH0_CLIENT_ID: "${ssm:/WEB_TOOL_APdI/dev/auth0/clientID}",
      AUTH0_CLIENT_SECRET: "${ssm:/WEB_TOOL_API/dev/auth0/clientSecret}",
      OPENAI_API_KEY: "${ssm:/WEB_TOOL_API/openai/secret}",
      POSTGRES_USER: "web-tool",
      POSTGRES_PASSWORD: "webtoolpassword",
      POSTGRES_DB: "web-tool",
      DRIZZLE_DATABASE_URL: "${ssm:/WEB_TOOL_API/dev/drizzle/database_url}",
    },
  },
